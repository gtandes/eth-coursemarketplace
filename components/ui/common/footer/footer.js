	...
	return (
		<footer className='bg-white'>
			<div className='px-4 py-16 mx-auto max-w-screen-xl sm:px-6 lg:px-8'>
				<div className='flex flex-col items-center p-6 bg-indigo-600 rounded-lg shadow-lg gap-4 sm:flex-row sm:justify-between'>
					...
					<Link href='/marketplace'>
						<a className='inline-flex items-center px-8 py-3 text-indigo-600 bg-white border border-white rounded-full hover:bg-transparent hover:text-white active:bg-white/90 focus:outline-none focus:ring'>
							<span className='text-sm font-medium'> Let Us Get Started </span>
				...
				<div className='mt-16 sm:mt-12 sm:flex sm:items-center justify-center sm:justify-between'>
					<div className='col-span-2 lg:col-span-3 lg:flex lg:items-end'>
						<form className='w-full'>
							...
							<div className='p-2 border sm:flex sm:items-center border-white/10'>
								<input
									className='w-full h-12 p-3 text-sm text-center font-medium tracking-widest placeholder-gray-400 uppercase bg-transparent border-none '
									type='email'
									id='email'
								...
								<button
									className='w-full h-12 px-6 py-3 mt-1 text-sm font-bold tracking-wide uppercase text-white bg-indigo-700 sm:ml-4 sm:flex-shrink-0 sm:w-auto sm:mt-0 hover:bg-indigo-700/75'
									type='submit'>
									Request Demo
								</button>
							</div>
					...
					<div className='relative inline-block px-10 py-3 text-indigo-600 border rounded-full border-current group'>
				...
				<div className='mt-16 sm:mt-12 sm:flex sm:justify-center sm:items-center'>
					<div className='justify-center'>
						<p className='mt-4 text-sm text-center text-gray-500 sm:mt-0 sm:text-right'>
							Copyright © {new Date().getFullYear()} GTA Media
						</p>
					</div>
				</div>
			</div>
